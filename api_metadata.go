...
func (a *MetadataApiService) GetVersionExecute(r ApiGetVersionRequest) (*InlineResponse2001, *http.Response, error) {
	var (
...
func (a *MetadataApiService) IsAliveExecute(r ApiIsAliveRequest) (*InlineResponse200, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Execute executes the request
//  @return InlineResponse200
func (a *MetadataApiService) IsReadyExecute(r ApiIsReadyRequest) (*InlineResponse200, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
